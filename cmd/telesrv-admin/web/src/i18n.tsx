...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "giveGift.senderHint": "Gifts are always sent from the system account 777000 (Whatsgram).",
    ...
    "giveGifts.hint": "Pick a gift to grant. Delivery is free of charge and sent from the system account 777000 (Whatsgram) by default.",
  ...
  zh: {
    ...
    "giveGift.senderHint": "礼物始终由系统账号 777000（Whatsgram）发送。",
    ...
    "giveGifts.hint": "选择要发放的礼物。发放免费，默认由系统账号 777000（Whatsgram）发送。",
  ...
  ru: {
    ...
    "giveGift.senderHint": "Подарки всегда отправляются от системного аккаунта 777000 (Whatsgram).",
    ...
    "giveGifts.hint": "Выберите подарок для выдачи. Выдача бесплатна и по умолчанию отправляется от системного аккаунта 777000 (Whatsgram).",
